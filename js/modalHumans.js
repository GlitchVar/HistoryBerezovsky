function openHumanModal(event) {
    ...
    <img src="img/kuzma.jpg" style="border-radius: 20px; position: relative; top: -100px;" width="272" height="358" loading="lazy">
    <button type="submit" class="close-btn-modal">X</button>`;
    modal.style.width = "1351px";
    modal.style.height = "529px";
    ...
    <img src="img/gustav-roze.jpg" style="border-radius: 20px; position: relative; top: -100px;" width="272" height="358" loading="lazy">
    <button type="submit" class="close-btn-modal">X</button>`;
    modal.style.width = "1351px";
    modal.style.height = "529px";
    ...
    <img src="img/erofey.jpg" style="border-radius: 20px; position: relative; top: -100px;" width="175.87" height="327" loading="lazy">
    <button type="submit" class="close-btn-modal">X</button>`;
