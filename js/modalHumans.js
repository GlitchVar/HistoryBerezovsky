function openHumanModal(event) {
    ...
    Продолжал работу по организации золотодобычи по 1845 год</p>
    <img src="img/lev1.jpg" style="border-radius: 20px;" width="200" height="358" loading="lazy">
    <button type="submit" class="close-btn-modal">X</button>`;
    ...
    <img src="img/kuzma.jpg" style="border-radius: 20px; position: relative; top: -100px; left: -50px;" width="272" height="358" loading="lazy">
    <button type="submit" class="close-btn-modal">X</button>`;
    ...
    <img src="img/gustav-roze.jpg" style="border-radius: 20px; position: relative; top: -100px; left: -50px;" width="272" height="358" loading="lazy">
    <button type="submit" class="close-btn-modal">X</button>`;
    modal.style.width = "1351px";
    ...
    <img src="img/erofey.jpg" style="border-radius: 20px; position: relative; top: -100px; left: -50px;" width="175.87" height="327" loading="lazy">
    <button type="submit" class="close-btn-modal">X</button>`;
