function openModal(event) {
    ...
    if(modalId === 'modal1') {
        modalContent.innerHTML = `<p>Парк Победы открыт 9 мая 1975 года, как раз в канун празднования 30-летия Победы над фашистскими захватчиками.<br> 
                ...
                <img src="img/pobeda2.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <img src="img/pobeda3.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
        ...
        modalContent.innerHTML = `<p>Музей золота в Березовском был создан в 1970 году по инициативе краеведа Сильвии Опёнкиной.
                ...
                <img src="img/holl.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <img src="img/cube.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <button type="submit" class="close-btn">X</button>`;
        ...
        modalContent.innerHTML = `<p>Исторический сквер в Березовском - центральное место и место образования города. 
                ...
                <img src="img/most-skver.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <img src="img/erofey3.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <button type="submit" class="close-btn">X</button>`;
        ...
        modalContent.innerHTML = `<p>Шиловский пруд – искусственный водоём на русле реки Шиловка (правый приток реки Пышма) в черте города Берёзовского Свердловской области,
                ...
                <img src="img/shilPrud-vid.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <img src="img/5.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <button type="submit" class="close-btn">X</button>`;
        ...
        modalContent.innerHTML = `<p>Тропа здоровья появилась в Берёзовском в конце 1970 гг. Летом 2008 года Тропа была обновлена, благоустроена. 
                ...
                <img src="img/tropa1.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <img src="img/tropa3.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <button type="submit" class="close-btn">X</button>`;
        ...
        modalContent.innerHTML = `<p>Скульптурная Композиция Дворик расположена в центральной части российского города Березовский, что в Свердловской области. 
                ...
                <img src="img/2.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <img src="img/3.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <button type="submit" class="close-btn">X</button>`;
        ...
        modalContent.innerHTML = `<p>В 1803 г., в конце декабря, после пожара, берёзовские жители остались без единственного  Пророко-Илиинского храма. 
                ...
                <img src="img/church3.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <img src="img/church1.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <button type="submit" class="close-btn">X</button>`;
        ...
        В 1930-е годы здание отдали школе, а позже здесь размещалась администрация города. В наши дни в этом здании расположен военкомат.</p>
                <img src="img/dom-kupza.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <img src="img/dom-kupza2.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <button type="submit" class="close-btn">X</button>`;
        ...
        рыбаке и рыбке» и другие. Всю эту красоту создал сын кузнеца Николая Вольхина Виктор.</p>
                <img src="img/dom-kuzniza1.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <img src="img/dom-kuzniza2.jpg" style="border-radius: 20px;" width="377" height="348" loading="lazy">
                <button type="submit" class="close-btn">X</button>`;
    } 
